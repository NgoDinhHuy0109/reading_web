...
<head>
    ...
    <link rel="stylesheet" href="news_page/user_addarticle.css">
...
<div class="container_addpost">
    ...
    <div class="analyse_article">
        <div class="status_article">
            <form class="article_form" action="createArticle" method="post">
                <input type="hidden" name="action" value="createNew1">
                <label>Title Article: </label><br>
                <input type="text" name="titleMain" placeholder="Enter title..." required><br>
...
<script src="news_page/script1.js"></script>
