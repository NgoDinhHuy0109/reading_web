...
<div class="main_info_user">
    ...
    <div class="container_info_user_right">
        ...
        <div class="p_info">
            <p> Day la noi dung Giữ đúng lời hứa, Tesla đã bắt đầu bàn giao những chiếc Cybertruck đầu tiên tới một nhóm
                khách hàng trong một sự kiện kéo dài 30 phút. Đích thân Elon Musk là người bàn giao những chiếc
                Cybertruck đầu tiên. Hiện Tesla đã cho khách hàng đặt mua trước trên trang web với ba phiên bản, bản rẻ
                nhất thì 2025 mới mở bán.
                Như vậy sau vài lần trễ hẹn thì Cybertruck chính thức sẵn sàng, chiếc xe bán tải chạy điện có thiết kế
                khác người. Nó được bàn giao cho người mua sau khoảng 6 năm kể từ khi Elon Musk hé lộ ý tưởng xe tải
                điện và khoảng 4 năm sau khi công bố những hình ảnh đầu tiên.</p>
        </div>
        <div class="p_info">
        ...
        <div class="cmt_form">
            ...
            <div class="righttlcmt_form">
                <div class="tl_cmt">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ab et consequuntur a ipsum, incidunt,
                        commodi praesentium quo sit ipsa provident similique vero dolor ad nihil placeat distinctio.
                        Consequuntur, minus laboriosam? fgfdgfgfdggggggggggggggggggggggggggggggggg</p>
                </div>
