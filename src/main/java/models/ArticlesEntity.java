...
public class ArticlesEntity implements Serializable{
    ...
    public void setInteractionsByInteractionId(Collection<InteractionsEntity> interactionsByInteractionId){
        this. listInteraction= interactionsByInteractionId;
    }
    public Collection<CommentsEntity> getCommentsByCommentId(){return listComment;}
    public void setCommentsByCommentId(Collection<CommentsEntity> commentsByCommentId){
        this.listComment = commentsByCommentId;
    }
    @Override
    public int hashCode() {
